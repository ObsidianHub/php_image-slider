...
function Photogallery(var3) {
   $.ajax({
      type: 'POST', url: 'select.php', data: { var1: 'ajax', var2: 'test2', vars: var3 }, success: function (response) {
...
$(document).ready(function () {
   $.ajax({
      type: 'POST', url: 'select.php', success: function (response) {
